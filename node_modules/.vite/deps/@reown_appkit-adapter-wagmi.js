...
import "./chunk-MFNHCWC7.js";
import "./chunk-3XG7XPXI.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
  ...
  secp256k1,
  weierstrassPoints
} from "./chunk-H2556FK2.js";
import {
  HashMD,
  sha256
} from "./chunk-MJK4HLXX.js";
import "./chunk-J2LIGHBK.js";
import {
  SwitchChainError,
...
import "./chunk-BCOTOJN4.js";
import "./chunk-MBAHVU6N.js";
import "./chunk-DMZREV6X.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider({ chainId } = {}) {
      ...
      if (chainId && currentChainId !== chainId && activeNamespace) {
        ...
        const appKitCaipNetworks = appKit == null ? void 0 : appKit.getCaipNetworks(activeNamespace);
    ...
    async getChainId() {
      ...
      const provider = await this.getProvider();
      const chain2 = (_d = (_c = (_b = provider.session) == null ? void 0 : _b.namespaces[ConstantsUtil.CHAIN.EVM]) == null ? void 0 : _c.chains) == null ? void 0 : _d[0];
...
var WagmiAdapter = class extends AdapterBlueprint {
  ...
  async getAccounts(params) {
    ...
    if (connector.id === ConstantsUtil.CONNECTOR_ID.AUTH) {
      ...
      const { address: address2, accounts } = await provider.connect();
      return Promise.resolve({
  ...
  async addThirdPartyConnectors(options) {
    ...
    if (options.enableCoinbase !== false) {
      try {
        const { coinbaseWallet } = await import("./exports-EXM26FGC.js");
        if (coinbaseWallet) {
  ...
  addWagmiConnectors(options, appKit) {
    ...
    const emailEnabled = ((_a = options.features) == null ? void 0 : _a.email) === void 0 ? ConstantsUtil2.DEFAULT_FEATURES.email : (_b = options.features) == null ? void 0 : _b.email;
    const socialsEnabled = ((_c = options.features) == null ? void 0 : _c.socials) ? ((_e = (_d = options.features) == null ? void 0 : _d.socials) == null ? void 0 : _e.length) > 0 : ConstantsUtil2.DEFAULT_FEATURES.socials;
