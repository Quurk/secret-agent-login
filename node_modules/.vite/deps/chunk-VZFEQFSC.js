import {
  fallback,
  http
} from "./chunk-4BJ72W2E.js";
import {
  solana,
  solanaDevnet
} from "./chunk-MFNHCWC7.js";
import {
  toHex
} from "./chunk-4KHKQJ4N.js";
import {
  AccountController,
  AlertController,
  ApiController,
...
var WalletUtil = {
  ...
  getConnectOrderMethod(_features, _connectors) {
    ...
    return ConstantsUtil3.DEFAULT_CONNECT_METHOD_ORDER;
  }
};
...
var PresetsUtil = {
  ConnectorExplorerIds: {
    ...
    [ConstantsUtil4.METMASK_CONNECTOR_NAME]: "c57ca95b47569778a828d19178114f4db188b89b763c899ba0be274e97267d96",
    [ConstantsUtil4.TRUST_CONNECTOR_NAME]: "4622a2b2d6af1c9844944291e5e7351a6aa24cd7b23099efac1b2fd875da31a0",
    [ConstantsUtil4.SOLFLARE_CONNECTOR_NAME]: "1ca0bdd4747578705b1939af023d120677c64fe6ca76add81fda36e350605e79",
    [ConstantsUtil4.PHANTOM_CONNECTOR_NAME]: "a797aa35c0fadbfc1a53e7f675162ed5226968b44a19ee3d24385c64d1d3c393",
    [ConstantsUtil4.COIN98_CONNECTOR_NAME]: "2a3c89040ac3b723a1972a33a125b1db11e258a6975d3a61252cd64e6ea5ea01",
    [ConstantsUtil4.MAGIC_EDEN_CONNECTOR_NAME]: "8b830a2b724a9c3fbab63af6f55ed29c9dfa8a55e732dc88c80a196a2ba136c6",
    [ConstantsUtil4.BACKPACK_CONNECTOR_NAME]: "2bd8c14e035c2d48f184aaa168559e86b0e3433228d3c4075900a221785019b0",
    [ConstantsUtil4.BITGET_CONNECTOR_NAME]: "38f5d18bd8522c244bdd70cb4a68e0e718865155811c043f052fb9f1c51de662",
    [ConstantsUtil4.FRONTIER_CONNECTOR_NAME]: "85db431492aa2e8672e93f4ea7acf10c88b97b867b0d373107af63dc4880f041"
  },
  NetworkImageIds: {
...
var HelpersUtil = {
  getCaipTokens(tokens) {
    ...
    Object.entries(tokens).forEach(([id, token]) => {
      caipTokens[`${ConstantsUtil4.EIP155}:${id}`] = token;
    });
    return caipTokens;
  },
...
var WcHelpersUtil = {
  ...
  isSessionEventData(data3) {
    return typeof data3 === "object" && data3 !== null && "id" in data3 && "topic" in data3 && "params" in data3 && typeof data3.params === "object" && data3.params !== null && "chainId" in data3.params && "event" in data3.params && typeof data3.params.event === "object" && data3.params.event !== null;
  }
};
...
var AppKit = class {
    ...
    this.networkControllerClient = {
      switchCaipNetwork: async (caipNetwork) => {
        ...
        if (AccountController.state.address && caipNetwork.chainNamespace === ChainController.state.activeChain) {
          ...
          const providerType = ProviderUtil.state.providerIds[ChainController.state.activeChain];
          if (providerType === ConstantsUtil4.CONNECTOR_TYPE_AUTH) {
            try {
              ...
              await ((_b = (_a = this.connectionControllerClient) == null ? void 0 : _a.connectExternal) == null ? void 0 : _b.call(_a, {
                ...
                chainId: caipNetwork.id,
                type: ConstantsUtil4.CONNECTOR_TYPE_AUTH,
                caipNetwork
              }));
              this.setCaipNetwork(caipNetwork);
            } catch (error) {
      ...
      getApprovedCaipNetworksData: async () => {
        var _a, _b, _c, _d, _e;
        const providerType = ProviderUtil.state.providerIds[ChainController.state.activeChain];
        if (providerType === ConstantsUtil4.CONNECTOR_TYPE_WALLET_CONNECT) {
    ...
    if (this.universalProvider) {
      ...
      this.universalProvider.on("session_event", (callbackData) => {
        if (WcHelpersUtil.isSessionEventData(callbackData)) {
          const { name, data: data3 } = callbackData.params.event;
          if (name === "accountsChanged" && Array.isArray(data3) && CoreHelperUtil.isCaipAddress(data3[0])) {
            this.syncAccount(ParseUtil.parseCaipAddress(data3[0]));
          }
        }
      });
    }
  ...
  async syncWalletConnectAccount() {
    ...
    this.chainNamespaces.forEach(async (chainNamespace) => {
      ...
      if (sessionAddress) {
        ...
        ProviderUtil.setProviderId(chainNamespace, ConstantsUtil4.CONNECTOR_TYPE_WALLET_CONNECT);
  ...
  syncConnectedWalletInfo(chainNamespace) {
    ...
    if (providerType === ConstantsUtil4.CONNECTOR_TYPE_ANNOUNCED || providerType === ConstantsUtil4.CONNECTOR_TYPE_INJECTED) {
      if (connectorId) {
    ...
    } else if (providerType === ConstantsUtil4.CONNECTOR_TYPE_WALLET_CONNECT) {
  ...
  async injectModalUi() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([
          import("./esm-N33LOED4.js"),
          import("./w3m-modal-PWK24FXV.js")
        ]);
...
var W3mRouter = class W3mRouter2 extends LitElement {
  ...
  firstUpdated() {
    this.resizeObserver = new ResizeObserver(([content]) => {
      ...
      }, ConstantsUtil3.ANIMATION_DURATIONS.ModalHeight);
    });
  ...
  onViewChange(newView) {
    ...
    let direction = ConstantsUtil3.VIEW_DIRECTION.Next;
    const { history } = RouterController.state;
    if (history.length < this.prevHistoryLength) {
      direction = ConstantsUtil3.VIEW_DIRECTION.Prev;
    }
    this.prevHistoryLength = history.length;
    this.viewDirection = direction;
    setTimeout(() => {
      this.view = newView;
    }, ConstantsUtil3.ANIMATION_DURATIONS.ViewTransition);
  }
  getWrapper() {
    var _a;
...
var W3mConnectView = class W3mConnectView2 extends LitElement {
  ...
  checkIfAuthEnabled(connectors) {
    const namespacesWithAuthConnector = connectors.filter((c) => c.type === ConstantsUtil4.CONNECTOR_TYPE_AUTH).map((i) => i.chain);
...
W3mConnectingWcBasicView = __decorate16([
...
W3mChooseAccountNameView = __decorate17([
...
W3mRegisterAccountNameView = __decorate20([
...
W3mRegisterAccountNameSuccess = __decorate21([
...
W3mNetworkSwitchView = __decorate22([
...
W3mOnRampActivityView = __decorate24([
...
W3mOnrampFiatSelectView = __decorate25([
...
W3mOnRampProvidersView = __decorate26([
...
W3mOnrampTokensView = __decorate27([
...
W3mSwitchActiveChainView = __decorate29([
...
W3mSwapPreviewView = __decorate30([
...
W3mSwapSelectTokenView = __decorate31([
...
W3mTransactionsView = __decorate32([
...
W3mWhatIsANetworkView = __decorate33([
...
W3mWhatIsAWalletView = __decorate34([
...
W3mWhatIsABuyView = __decorate35([
...
W3mEmailOtpWidget = __decorate36([
...
W3mEmailVerifyOtpView = __decorate37([
...
W3mEmailVerifyDeviceView = __decorate38([
...
W3mApproveTransactionView = __decorate39([
...
W3mUpgradeWalletView = __decorate40([
  ...
  constructor() {
    ...
    this.handleSocialConnection = async (event) => {
      ...
      if ((_a = event.data) == null ? void 0 : _a.resultUri) {
        if (event.origin === ConstantsUtil3.SECURE_SITE_ORIGIN) {
...
var W3mHeader = class W3mHeader2 extends LitElement {
  constructor() {
    ...
    this.unsubscribe.push(AssetController.subscribeNetworkImages(() => {
      ...
      }, ConstantsUtil3.ANIMATION_DURATIONS.HeaderText);
      this.onViewChange();
...
//# sourceMappingURL=chunk-VZFEQFSC.js.map
